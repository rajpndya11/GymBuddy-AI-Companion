...
export const ProfileScreen: React.FC<ProfileScreenProps> = ({
  ...
  return (
    <div className="w-full max-w-md mx-auto p-4 pb-24 text-[#FFFFFF] animate-fade-in space-y-4">
      ...
      {/* User Card */}
      <div className="bg-gradient-to-br from-[#171717] to-[#121212] border border-[#2A2F3F] rounded-3xl p-5 shadow-xl flex items-center gap-4">
        <div className="w-16 h-16 rounded-2xl bg-[#131826] border-2 border-[#8B5CF6] flex items-center justify-center font-black text-2xl text-[#8B5CF6] shadow-md">
          {userProfile.name ? userProfile.name.charAt(0).toUpperCase() : 'A'}
        </div>

        <div className="flex-1">
          <h2 className="text-xl font-bold text-[#FFFFFF]">{userProfile.name || 'Athlete'}</h2>
          <p className="text-xs text-[#A1A8B8] mt-0.5">
            {userProfile.age} yrs · {userProfile.height} {userProfile.heightUnit} · {userProfile.weight}{' '}
            {userProfile.weightUnit}
          </p>
          <div className="flex items-center gap-2 mt-2">
            <span className="text-[10px] font-bold uppercase px-2 py-0.5 rounded-full bg-[#8B5CF6]/15 text-[#8B5CF6] border border-[#8B5CF6]/30">
              {userProfile.goal}
            </span>
      ...
      <div className="bg-[#131826] border border-[#2A2F3F] rounded-2xl p-4 space-y-3">
        <h3 className="text-xs font-bold uppercase tracking-wider text-[#A1A8B8]">
        ...
        <div className="flex items-center justify-between text-xs py-1.5 border-b border-[#1C1C1C]">
          ...
          <span className="font-bold text-[#FFFFFF]">{userProfile.goal}</span>
        </div>
        ...
        <div className="flex items-center justify-between text-xs py-1.5 border-b border-[#1C1C1C]">
          ...
          <span className="font-bold text-[#FFFFFF]">{userProfile.scheduleDays} days / week</span>
        </div>
        ...
        <div className="flex items-center justify-between text-xs py-1.5 border-b border-[#1C1C1C]">
          ...
          <span className="font-bold text-[#FFFFFF]">{userProfile.duration}</span>
        </div>
        ...
        <div className="flex items-center justify-between text-xs py-1.5">
          ...
          <span className="font-bold text-[#FFFFFF]">{userProfile.equipment}</span>
        </div>
      </div>

      {/* Units & Settings */}
      <div className="bg-[#131826] border border-[#2A2F3F] rounded-2xl p-4 space-y-2.5">
        <h3 className="text-xs font-bold uppercase tracking-wider text-[#A1A8B8]">
          Preferences & Units
        </h3>
        ...
        <div className="flex items-center justify-between py-1">
          ...
          <button
            ...
            className="px-3 py-1 text-xs font-bold font-mono rounded-lg bg-[#131826] border border-[#2A2F3F] text-[#8B5CF6] hover:bg-[#252525] transition-colors"
          >
      ...
      <button
        ...
        className="w-full bg-[#131826] hover:bg-[#181818] border border-[#2A2F3F] rounded-2xl p-4 flex items-center justify-between transition-colors"
      >
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-xl bg-[#131826] border border-[#2A2F3F] flex items-center justify-center overflow-hidden">
          ...
          <div className="text-left">
            <div className="text-xs font-bold text-[#FFFFFF] flex items-center gap-1.5">
              ...
              <span className="text-[9px] bg-[#8B5CF6]/20 text-[#8B5CF6] px-1.5 py-0.5 rounded-full font-mono font-bold">
                NEW
              </span>
            </div>
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="text-left">
            <div className="text-xs font-bold text-[#FFFFFF]">V2 Capabilities Roadmap</div>
            <div className="text-[10px] text-[#A1A8B8]">Camera AI form analysis, wearables & voice</div>
          </div>
        </div>
        <ChevronRight className="w-4 h-4 text-[#A1A8B8]" />
      </button>
      ...
      <div className="space-y-2.5 pt-2">
        <button
          ...
          className="w-full py-3.5 px-4 rounded-xl bg-[#131826] hover:bg-[#242424] border border-[#2A2F3F] text-xs font-bold text-[#FFFFFF] transition-colors btn-press flex items-center justify-center gap-2"
        >
        ...
        <button
          ...
          className="w-full py-3 px-4 rounded-xl bg-transparent hover:bg-[#1A1A1A] text-xs font-semibold text-[#A1A8B8] hover:text-[#FF5C5C] transition-colors flex items-center justify-center gap-1.5"
        >
      ...
      {showResetConfirmModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-sm animate-fade-in">
          <div className="w-full max-w-sm bg-[#161616] border border-[#2A2F3F] rounded-3xl p-5 shadow-2xl space-y-4">
            ...
            <div className="text-center">
              ...
              <p className="text-xs text-[#A1A8B8] mt-1.5 leading-relaxed">
      ...
      {showEditModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-sm animate-fade-in overflow-y-auto">
          <div className="w-full max-w-sm bg-[#131826] border border-[#2A2F3F] rounded-3xl p-5 shadow-2xl my-6">
            <h3 className="text-base font-bold text-[#FFFFFF] mb-4">Edit Profile & Plan</h3>

            <div className="space-y-3 mb-5 max-h-[65vh] overflow-y-auto pr-1">
              <div>
                <label className="text-[10px] uppercase font-bold text-[#A1A8B8] block mb-1">
                  Name
                </label>
                <input
                  type="text"
                  ...
                  className="w-full bg-[#131826] border border-[#333] rounded-xl px-3 py-2 text-xs text-[#FFFFFF] focus:outline-none focus:border-[#8B5CF6]"
                />
              </div>
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 py-2.5 rounded-xl bg-[#222] text-[#A1A8B8] text-xs font-semibold"
              >
                Cancel
              </button>
              <button
                onClick={saveProfileEdits}
                className="flex-1 py-2.5 rounded-xl bg-[#8B5CF6] text-black text-xs font-bold btn-press"
              >
                Save Changes
              </button>
            </div>
      ...
      {showV2Roadmap && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-sm animate-fade-in">
          <div className="w-full max-w-sm bg-[#131826] border border-[#2A2F3F] rounded-3xl p-5 shadow-2xl">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                <Sparkles className="w-4 h-4 text-[#A78BFA]" />
                <h3 className="text-sm font-bold text-[#FFFFFF]">V2 Capabilities Roadmap</h3>
              </div>
              <button
                onClick={() => setShowV2Roadmap(false)}
                className="text-xs text-[#A1A8B8] hover:text-[#FFFFFF]"
              >
                ✕
              </button>
            </div>
            ...
            <div className="space-y-2 text-xs mb-5">
              <div className="bg-[#131826] p-2.5 rounded-xl border border-[#2A2A2A]">
                <div className="font-bold text-[#8B5CF6]">📷 Camera-Based Form Analysis</div>
                <p className="text-[10px] text-[#A1A8B8]">Real-time joint tracking on phone camera</p>
              </div>
              <div className="bg-[#131826] p-2.5 rounded-xl border border-[#2A2A2A]">
                <div className="font-bold text-[#A78BFA]">🎙️ Live Audio Voice Coach</div>
                <p className="text-[10px] text-[#A1A8B8]">Spoken countdowns and rep encouragement in ear</p>
              </div>
              <div className="bg-[#131826] p-2.5 rounded-xl border border-[#2A2A2A]">
                <div className="font-bold text-[#60A5FA]">⌚ Smartwatch Integration</div>
                <p className="text-[10px] text-[#A1A8B8]">Heart-rate synchronization and haptic rest bells</p>
              </div>
            </div>

            <button
              onClick={() => setShowV2Roadmap(false)}
              className="w-full py-2.5 rounded-xl bg-[#8B5CF6] text-black text-xs font-bold btn-press"
            >
              Close
            </button>
          </div>
      ...
      {showLogoGuide && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 bg-black/85 backdrop-blur-md animate-fade-in">
          <div className="w-full max-w-md max-h-[90vh] bg-[#131826] border border-[#2A2F3F] rounded-3xl p-5 shadow-2xl flex flex-col overflow-y-auto">
            {/* Modal Header */}
            <div className="flex items-center justify-between pb-3 border-b border-[#2A2F3F] mb-4">
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 rounded-lg bg-[#131826] border border-[#333] flex items-center justify-center">
                  <Layers className="w-3.5 h-3.5 text-[#8B5CF6]" />
                </div>
                <div>
                  <h3 className="text-sm font-bold text-[#FFFFFF]">Official GymBuddy Logo Assets</h3>
                  <p className="text-[10px] text-[#A1A8B8]">Vector resolution & sizing guide</p>
                </div>
              </div>
              <button
                onClick={() => setShowLogoGuide(false)}
                className="w-7 h-7 rounded-full bg-[#131826] hover:bg-[#252525] text-[#A1A8B8] hover:text-[#FFFFFF] flex items-center justify-center text-xs"
              >
                ✕
              </button>
            </div>
            ...
            <div className="bg-[#080808] border border-[#2A2F3F] rounded-2xl p-6 flex flex-col items-center justify-center min-h-[170px] relative overflow-hidden mb-4 shadow-inner">
            ...
            <div className="space-y-3 mb-4">
              {/* Variant Switcher */}
              <div>
                <label className="text-[10px] uppercase font-bold text-[#A1A8B8] block mb-1.5">
                  Display Variant
                </label>
                    ...
                    <button
                      ...
                      className={`py-1.5 px-2 rounded-xl text-[11px] font-bold transition-all ${
                        previewVariant === v.id
                          ...
                          : 'bg-[#131826] text-[#A1A8B8] hover:text-[#FFFFFF]'
                      }`}
                    >
                      {v.label}
                    </button>
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={`py-1 rounded-lg text-[10px] font-mono font-bold transition-all ${
                        previewSize === s.id
                          ? 'bg-[#2E2E2E] text-[#8B5CF6] border border-[#8B5CF6]'
                          : 'bg-[#1A1A1A] text-[#A1A8B8] hover:text-[#D4D4D4]'
                      }`}
                    >
                      {s.label}
                    </button>
            ...
            <div className="border-t border-[#2A2F3F] pt-3.5 space-y-2 mb-4">
              <h4 className="text-[11px] font-bold text-[#FFFFFF] uppercase tracking-wider mb-2">
                Which Logo Size Is Perfect for You?
              </h4>

              <div className="space-y-2 text-xs">
                <div className="bg-[#181818] p-2.5 rounded-xl border border-[#2A2F3F]">
                  <div className="flex items-center justify-between font-bold text-[#FFFFFF]">
                    <span className="flex items-center gap-1.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#8B5CF6]" />
                      32x32 & 48x48 (Favicon)
                    </span>
                    <span className="text-[10px] text-[#8B5CF6] font-mono">ACTIVE IN BROWSER</span>
                  </div>
                  <p className="text-[10px] text-[#A1A8B8] mt-0.5">
                ...
                <div className="bg-[#181818] p-2.5 rounded-xl border border-[#2A2F3F]">
                  <div className="flex items-center justify-between font-bold text-[#8B5CF6]">
                    ...
                    <span className="text-[10px] text-[#8B5CF6] font-mono">USED EVERYWHERE</span>
                  </div>
                  <p className="text-[10px] text-[#A1A8B8] mt-0.5">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 py-2.5 px-3 rounded-xl bg-[#131826] hover:bg-[#252525] border border-[#2A2F3F] text-xs font-semibold text-[#D4D4D4] flex items-center justify-center gap-1.5 transition-colors"
              >
                {copiedSvg ? (
                  <>
                    <Check className="w-3.5 h-3.5 text-[#8B5CF6]" />
                    <span className="text-[#8B5CF6]">Copied Component!</span>
                  </>
                ) : (
                  <>
              ...
              <button
                onClick={() => setShowLogoGuide(false)}
                className="py-2.5 px-5 rounded-xl bg-[#8B5CF6] text-black text-xs font-bold btn-press"
              >
                Done
              </button>
            </div>
